...
plt.savefig('pics/2-1-Power spectrum.png', dpi=500)
...
plt.savefig('pics/2-1-Spectrogram.png', dpi=500)
...
plt.savefig('pics/2-1-ACF and PACF of 10Hz Sine Wave.png', dpi=500)
plt.tight_layout()
plt.show()
...
plt.tight_layout()
plt.savefig('pics/2-1-ACF and PACF of 20Hz Sine Wave.png', dpi=500)
plt.show()
