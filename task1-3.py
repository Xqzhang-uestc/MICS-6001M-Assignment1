...
plt.savefig('1-3-line_plot.png', dpi=500)
plt.show()
...
plt.savefig('1-3-histogram.png', dpi=500)
plt.show()
...
plt.xlabel('Temperature Anomalies')
plt.ylabel('Density')
plt.savefig('1-3-density_plot.png', dpi=500)
plt.show()
...
plt.xlabel('Temperature Anomalies')
plt.savefig('1-3-box_plot.png', dpi=500)
plt.show()
...
plt.xlabel('Temperature Anomalies')
plt.savefig('1-3-heatmap.png', dpi=500)
plt.show()
...
plt.savefig('1-3-lag1_plot.png', dpi=500)
plt.show()
...
plt.savefig('1-3-acf_plot.png', dpi=500)
plt.show()
...
plt.savefig('1-3-pacf_plot.png', dpi=500)
plt.show()
...
plt.savefig('1-3-diff_line_plot.png', dpi=500)
plt.show()
...
plt.ylabel('Frequency')
plt.savefig('1-3-diff_histogram.png', dpi=500)
plt.show()
...
plt.xlabel('First Order Difference of Temperature Anomalies')
plt.ylabel('Density')
plt.savefig('1-3-diff_density_plot.png', dpi=500)
plt.show()
...
plt.xlabel('First Order Difference of Temperature Anomalies')
plt.savefig('1-3-diff_box_plot.png', dpi=500)
plt.show()
...
plt.xlabel('First Order Difference of Temperature Anomalies')
plt.savefig('1-3-diff_heatmap.png', dpi=500)
plt.show()
...
plt.savefig('1-3-diff_lag1_plot.png', dpi=500)
plt.show()
...
plt.savefig('1-3-diff_acf_plot.png', dpi=500)
plt.show()
...
plt.savefig('1-3-diff_pacf_plot.png', dpi=500)
plt.show()
...
plt.savefig('1-3-stl_decomposition.png', dpi=500)
